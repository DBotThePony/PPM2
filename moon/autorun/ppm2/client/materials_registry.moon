...
module.BODY_MATERIAL_MALE = CreateMaterial('PPM2.MaleDrawtexture', 'UnlitGeneric', additionTable('$basetexture', 'models/ppm/base/bodym'))
module.BODY_MATERIAL_FEMALE = CreateMaterial('PPM2.FemaleDrawtexture', 'UnlitGeneric', additionTable('$basetexture', 'models/ppm/base/body'))
module.HORN_DETAIL_COLOR = Material('models/ppm/base/horn_detail')
