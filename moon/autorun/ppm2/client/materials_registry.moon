...
module.BODY_MATERIAL = CreateMaterial('PPM2.MaleDrawtexture', 'UnlitGeneric', additionTable('$basetexture', 'models/ppm/base/body'))
...
module.LIPS = Material('models/ppm/base/lips')
module.NOSE = Material('models/ppm/base/nose')
