...
EditorPages = {
...

    {
        ...
        'func': (sheet) =>
            ...
            @NumSlider('Left Wing X position', 'LWingX', 2, left)
            @NumSlider('Left Wing Y position', 'LWingY', 2, left)
            @NumSlider('Left Wing Z position', 'LWingZ', 2, left)
            right = @Spoiler('Right wing settings')
            @NumSlider('Right Wing Size', 'RWingSize', 2, right)
            @NumSlider('Right Wing X position', 'RWingX', 2, right)
            @NumSlider('Right Wing Y position', 'RWingY', 2, right)
            @NumSlider('Right Wing Z position', 'RWingZ', 2, right)
